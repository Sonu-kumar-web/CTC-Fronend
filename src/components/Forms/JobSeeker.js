            ...
            <form className="form" onSubmit={(e) => this.onSubmit(e)}>
               ...
               <div className="form-group">
                  ...
                  <small className="form-text">
                     Give us an idea about your working (i.e Fresher/Experience)
                  </small>
               </div>
               ...
               <div className="form-group">
                  ...
                  <small className="form-text">
                     Give us an idea about your interest
                  </small>
               </div>
               ...
               <div className="form-group">
                  <label>
                     <h4 style={{ display: "inline" }}>Upload Resume:</h4>
                  </label>
                  <input
                     type="file"
                     placeholder="Company"
                  ...
                  <div>
                     <div className="popup">
                        <h4 style={{ paddingLeft: "10px" }}>
                           There are 300 recruiters similar to your skills,
